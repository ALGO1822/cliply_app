...
abstract class $FolderCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, int iconCode, bool isDefault});
}
...
class _$FolderImpl implements _Folder {
  ...
  @override
  String toString() {
    return 'Folder(id: $id, name: $name, iconCode: $iconCode, isDefault: $isDefault)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, iconCode, isDefault);
...
abstract class _Folder implements Folder {
  const factory _Folder(
      ...
      final bool isDefault}) = _$FolderImpl;
