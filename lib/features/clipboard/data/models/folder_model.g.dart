...
extension FolderModelQueryFilter
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> iconCodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> iconCodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension FolderModelQuerySortBy
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByIconCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByIconCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.desc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQuerySortThenBy
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIconCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIconCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.desc);
    });
  }
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.desc);
    });
  }
...
extension FolderModelQueryWhereDistinct
  ...
  QueryBuilder<FolderModel, FolderModel, QDistinct> distinctByIconCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'iconCode');
    });
  }

  QueryBuilder<FolderModel, FolderModel, QDistinct> distinctByIsDefault() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQueryProperty
  ...
  QueryBuilder<FolderModel, int, QQueryOperations> iconCodeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'iconCode');
    });
  }

  QueryBuilder<FolderModel, bool, QQueryOperations> isDefaultProperty() {
    return QueryBuilder.apply(this, (query) {
